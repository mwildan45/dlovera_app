...
class TableLaporanStockPersediaanProdukWidget extends StatefulWidget {
  const TableLaporanStockPersediaanProdukWidget(
      {Key? key,
      required this.data,
      required this.vm,
  ...
  @override
  State<TableLaporanStockPersediaanProdukWidget> createState() =>
      _TableLaporanStockPersediaanProdukWidgetState();
}

class _TableLaporanStockPersediaanProdukWidgetState
    extends State<TableLaporanStockPersediaanProdukWidget> {
  ...
  void initState() {
    ...
    _laporanStockProdukDataSource = LaporanStockProdukBahanBakuDataSource(
        stockProdukBahanBaku: widget.data?.persediaanProduk?.data ?? []);
  }
        ...
        [
          ...
          CustomButton(
            ...
            onPressed: _laporanStockProdukDataSource.dataGridRows.isEmpty
                ? null
                : () => widget.vm.navigateToPersediaanProdukAll(widget.vm),
