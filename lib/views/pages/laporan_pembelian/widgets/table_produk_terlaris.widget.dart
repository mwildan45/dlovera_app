...
class TableLaporanPembelianProdukTerlarisWidget extends StatefulWidget {
  const TableLaporanPembelianProdukTerlarisWidget(
  ...
  @override
  State<TableLaporanPembelianProdukTerlarisWidget> createState() =>
      _TableLaporanPembelianProdukTerlarisWidgetState();
}

class _TableLaporanPembelianProdukTerlarisWidgetState
    extends State<TableLaporanPembelianProdukTerlarisWidget> {
